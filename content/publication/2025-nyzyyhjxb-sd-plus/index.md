...
summary: "气候变化已成为人类面临的最严峻的环境问题之一,全球气候变化和极端天气气候事件已经对人类经济社会有序发展产生了严重威胁。土地是承载水、能源、粮食等资源的重要基础,绝大部分社会经济活动都要依托土地这一载体。气候变化会加重各类土地间的竞争,造成土地退化和荒漠化等问题,对全球粮食安全产生严重威胁。同时,以人为主导的土地开发行为所导致的地表特征转变会影响陆地与大气间的水热循环,土地退化和荒漠化使得耕作开发加剧,土地系统变动所造成的生物多样性下降和温室气体额外排放又成为加剧气候变化的驱动力。本研究旨在研究气候变化背景下,利用SD-PLUS耦合模型,对杭州市土地利用进行多情景模拟。研究选取了2020年IPCC发布的共享经济路径(SSPs)与典型浓度路径(RCPs)耦合的SSP1-2.6、SSP2-4.5 和 SSP5-8.5三类气候情景数据,构建并验证了综合考虑各类社会经济因素及气候变化因素的SD-PLUS耦合预测模型,以2000—2020年为历史期,模拟预测了2030年杭州市各情景下的土地利用时空变化趋势,分析了不同气候变化情景下土地利用空间格局变化,以期为研究区实现土地资源和生态环境优化配置、经济生态均衡发展提供科学支撑。模型显示,SD模型预测误差在5%以内,Kappa值为0.84,模拟精度达到0.93,表明SD-PLUS模型能够准确预测土地利用变化。SSP2-4.5和SSP5-8.5情景下,森林和草地向建设用地的转化导致生态用地减少。SSP5-8.5情景下,建设用地扩张最为显著。SSP1-2.6情景下,建设用地主要侵占生态用地,但生态用地面积并未明显减少。SSP1-2.6情景下,生态保护用地有效缓解了城市化扩张,提高了土地利用效率,促进了经济和生态协调发展。"

tags:
- SD-PLUS coupled model
- land use change
...
url_pdf: '/papers/2025 农业资源与环境学报 基于SD PLUS耦合模型的杭州市土地利用多情景模拟.pdf'
url_code: ''
url_dataset: ''
url_poster: ''
url_project: ''
